 ...
 * 
 */
public class SyncDoctorForm implements ApiMessage {
	...
	public SyncDoctorForm() {
	}

	public SyncDoctorForm(long oldId, long id, long hospitalId, String name, String telephone, String mobile,
			long departmentId, String title, String username, String email, String gender, int type, String headPic,
			String oldPasswordSha1) {
		this.oldId = oldId;
		this.id = id;
	...
	public String toString() {
		return "SyncDoctorForm [oldId=" + oldId + ",id=" + id + ",hospitalId=" + hospitalId + ",name=" + name
				+ ",telephone=" + telephone + ",mobile=" + mobile + ",departmentId=" + departmentId + ",title=" + title
				+ ",username=" + username + ",email=" + email + ",gender=" + gender + ",type=" + type + ",headPic="
				+ headPic + ",oldPasswordSha1=" + oldPasswordSha1 + ", ]";
	}
}