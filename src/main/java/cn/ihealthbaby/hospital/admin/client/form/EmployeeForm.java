 ...
 * 
 */
public class EmployeeForm implements ApiMessage {
	...
	public EmployeeForm(long id, long hospitalId, String name, String telephone, String mobile, long departmentId,
	...
	public String toString() {
		return "EmployeeForm [id=" + id + ",hospitalId=" + hospitalId + ",name=" + name + ",telephone=" + telephone
